  ...
  const handleSubmit = () => {
    ...
    <Box maw="50%" mx="auto" my="md">
        <form onSubmit={(e) => {
            ...
            <Textarea placeholder='Description' label="Description" withAsterisk {...form.getInputProps("description")} />
            <NumberInput withAsterisk label="Price" placeholder='1000' min={0} {...form.getInputProps("price")} />
